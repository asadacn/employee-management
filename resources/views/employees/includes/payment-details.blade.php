<div class="card">
    <div class="card-header h5">{{__('Payments Details')}}</div>
    ...
    <div class="card-footer text-capitalized"> 
        <small class="text-muted"> {{__('payable')}} : {{$employee->total_due() ?? 0}} {{__('Tk.')}} | {{__('paid')}} : {{$employee->payments()->sum('amount') ?? '0'}} {{__('Tk.')}}</small> <br>
