            ...
            <table class="table table-sm table-bordered">
                ...
                <tbody>
                    @foreach ($employee->payments() as $payment)
                        ...
                        <td class="text-center "><span class=" text-{{$payment->salaryInfo->is_paid == 'yes' ? 'success':'warning'}}">{!!$payment->salaryInfo->is_paid == 'yes' ? '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
